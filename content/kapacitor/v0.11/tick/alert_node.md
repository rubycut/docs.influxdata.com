...
An [AlertNode](/kapacitor/v0.11/tick/alert_node/) can trigger an event of varying severity levels, 
...
See [AlertNode.Info,](/kapacitor/v0.11/tick/alert_node/#info) [AlertNode.Warn,](/kapacitor/v0.11/tick/alert_node/#warn) and [AlertNode.Crit](/kapacitor/v0.11/tick/alert_node/#crit) below. 

Different event handlers can be configured for each [AlertNode.](/kapacitor/v0.11/tick/alert_node/) 
...
Using the [AlertNode.StateChangesOnly](/kapacitor/v0.11/tick/alert_node/#statechangesonly) property events will only be sent to handlers 
...
-	[Alerta](/kapacitor/v0.11/tick/alert_node/#alerta)
-	[Crit](/kapacitor/v0.11/tick/alert_node/#crit)
-	[Details](/kapacitor/v0.11/tick/alert_node/#details)
-	[Email](/kapacitor/v0.11/tick/alert_node/#email)
-	[Exec](/kapacitor/v0.11/tick/alert_node/#exec)
-	[Flapping](/kapacitor/v0.11/tick/alert_node/#flapping)
-	[HipChat](/kapacitor/v0.11/tick/alert_node/#hipchat)
-	[History](/kapacitor/v0.11/tick/alert_node/#history)
-	[Id](/kapacitor/v0.11/tick/alert_node/#id)
-	[Info](/kapacitor/v0.11/tick/alert_node/#info)
-	[Log](/kapacitor/v0.11/tick/alert_node/#log)
-	[Message](/kapacitor/v0.11/tick/alert_node/#message)
-	[OpsGenie](/kapacitor/v0.11/tick/alert_node/#opsgenie)
-	[PagerDuty](/kapacitor/v0.11/tick/alert_node/#pagerduty)
-	[Post](/kapacitor/v0.11/tick/alert_node/#post)
-	[Sensu](/kapacitor/v0.11/tick/alert_node/#sensu)
-	[Slack](/kapacitor/v0.11/tick/alert_node/#slack)
-	[StateChangesOnly](/kapacitor/v0.11/tick/alert_node/#statechangesonly)
-	[Talk](/kapacitor/v0.11/tick/alert_node/#talk)
-	[VictorOps](/kapacitor/v0.11/tick/alert_node/#victorops)
-	[Warn](/kapacitor/v0.11/tick/alert_node/#warn)

### Chaining Methods

-	[Deadman](/kapacitor/v0.11/tick/alert_node/#deadman)
-	[Stats](/kapacitor/v0.11/tick/alert_node/#stats)
...
use [AlertNode.StateChangesOnly](/kapacitor/v0.11/tick/alert_node/#statechangesonly) so that only events 
...
Alerta group. 
Can be a template and has access to the same data as the [AlertNode.Details](/kapacitor/v0.11/tick/alert_node/#details) property. 
Default: {{ .Group }} 
...
The same template data is available as the [AlertNode.Message](/kapacitor/v0.11/tick/alert_node/#message) property, 
...
The email subject is the [AlertNode.Message](/kapacitor/v0.11/tick/alert_node/#message) property. 
The email body is the [AlertNode.Details](/kapacitor/v0.11/tick/alert_node/#details) property. 
