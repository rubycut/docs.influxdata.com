...
A [StatsNode](/kapacitor/v0.11/tick/stats_node/) emits internal statistics about the another node at a given interval. 

The interval represents how often to emit the statistics based on real time. 
This means the interval time is independent of the times of the data points the other node is receiving. 
As a result the [StatsNode](/kapacitor/v0.11/tick/stats_node/) is a root node in the task pipeline. 
...
-	[Alert](/kapacitor/v0.11/tick/stats_node/#alert)
-	[Bottom](/kapacitor/v0.11/tick/stats_node/#bottom)
-	[Count](/kapacitor/v0.11/tick/stats_node/#count)
-	[Deadman](/kapacitor/v0.11/tick/stats_node/#deadman)
-	[Derivative](/kapacitor/v0.11/tick/stats_node/#derivative)
-	[Distinct](/kapacitor/v0.11/tick/stats_node/#distinct)
-	[Eval](/kapacitor/v0.11/tick/stats_node/#eval)
-	[First](/kapacitor/v0.11/tick/stats_node/#first)
-	[GroupBy](/kapacitor/v0.11/tick/stats_node/#groupby)
-	[HttpOut](/kapacitor/v0.11/tick/stats_node/#httpout)
-	[InfluxDBOut](/kapacitor/v0.11/tick/stats_node/#influxdbout)
-	[Join](/kapacitor/v0.11/tick/stats_node/#join)
-	[Last](/kapacitor/v0.11/tick/stats_node/#last)
-	[MapReduce](/kapacitor/v0.11/tick/stats_node/#mapreduce)
-	[Max](/kapacitor/v0.11/tick/stats_node/#max)
-	[Mean](/kapacitor/v0.11/tick/stats_node/#mean)
-	[Median](/kapacitor/v0.11/tick/stats_node/#median)
-	[Min](/kapacitor/v0.11/tick/stats_node/#min)
-	[Percentile](/kapacitor/v0.11/tick/stats_node/#percentile)
-	[Sample](/kapacitor/v0.11/tick/stats_node/#sample)
-	[Shift](/kapacitor/v0.11/tick/stats_node/#shift)
-	[Spread](/kapacitor/v0.11/tick/stats_node/#spread)
-	[Stats](/kapacitor/v0.11/tick/stats_node/#stats)
-	[Stddev](/kapacitor/v0.11/tick/stats_node/#stddev)
-	[Sum](/kapacitor/v0.11/tick/stats_node/#sum)
-	[Top](/kapacitor/v0.11/tick/stats_node/#top)
-	[Union](/kapacitor/v0.11/tick/stats_node/#union)
-	[Where](/kapacitor/v0.11/tick/stats_node/#where)
-	[Window](/kapacitor/v0.11/tick/stats_node/#window)
