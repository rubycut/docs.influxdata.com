---
title: SourceStreamNode
note: Auto generated by tickdoc

menu:
  kapacitor_011:
    name: SourceStream
    identifier: source_stream_node
    weight: 190
    parent: tick
---

A [SourceStreamNode](/kapacitor/v0.11/tick/source_stream_node/) represents the source of data being 
streamed to Kapacitor via any of its inputs. 
The `stream` variable in stream tasks is an instance of 
a [SourceStreamNode.](/kapacitor/v0.11/tick/source_stream_node/) 
[SourceStreamNode.From](/kapacitor/v0.11/tick/source_stream_node/#from) is the method/property of this node. 
...
-	[Deadman](/kapacitor/v0.11/tick/source_stream_node/#deadman)
-	[From](/kapacitor/v0.11/tick/source_stream_node/#from)
-	[Stats](/kapacitor/v0.11/tick/source_stream_node/#stats)
...
Creates a new [StreamNode](/kapacitor/v0.11/tick/stream_node/) that can be further 
